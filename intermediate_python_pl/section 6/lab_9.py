...
Cake.export_1_cake_to_html(cake01, 'lab_9/cake01.html')

# class
Cake.export_all_cakes_to_html = types.MethodType(export_all_cakes_to_html, Cake)
Cake.export_all_cakes_to_html('lab_9/all_cakes.html')
...
for cake in Cake.bakery_offer:
    cake.export_this_cake_to_html(f'lab_9/{cake.name.replace(" ", "_")}.html')
